...
if [[ $URL = '' ]] ; then
	URL="http://dl.fedoraproject.org/pub/fedora/linux/development/rawhide/armhfp/os"
fi
...
ui menu.c32
menu autoboot Welcome to Fedora Rawhide Installer for ARM. Automatic boot in # second{,s}. Press a key for options.
menu title Fedora Rawhide Installer for ARM Boot Options.
menu hidden
timeout 20
totaltimeout 600

label Fedora Rawhide Installer for ARM
	kernel /vmlinuz
